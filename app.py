...
# Page Basic info
st.set_page_config(
	page_title = 'Personalised Nutrition Recommender System',
	page_icon = '::2a::'
)
...
def homepage():
	...
	st.title("Personalised Nutrition Recommender System")
	words = '''
	<p style="font-style:italic; font-family:cursive;">
	Nutrition Recommender System is a personalized System to recommend suggestion
	for diet and other sub domains like medicine and workout recommendation.
	</p>
	<p style="font-style:italic; font-family:cursive;">These are some of the sub-domains of the NAS.</p>
